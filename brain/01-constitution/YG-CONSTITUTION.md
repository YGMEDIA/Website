...
Jede Seite trägt identisch: Nav (**seit 2026-09-19 nur Sprachwechsler-Dropdown `.nav-lang`, rechtsbündig**, kein Logo und keine Menüpunkte; das Logo steht groß und animiert auf der Startseite, siehe P-16; transparent, Glass beim Scrollen; das Burger-Markup bleibt für das Skript, ist aber auch mobil ausgeblendet; kein Calendly-CTA, keine Service-Links, verify.py prüft das) · Footer (**seit 2026-09-19 eine Zeile `.footer-bottom`**: Copyright "© 2026 YG MEDIA" (ohne Personennamen, Yasin 2026-09-19) · `.footer-legal` mit Impressum/Datenschutz/Nutzungsbedingungen bzw. Legal Notice/Privacy Policy/Terms of Use · DE/EN-Pills `.lang-switch`; kein Logo, keine Tagline, keine Produkt- oder Unternehmensspalten, keine Social-Links. **X/Twitter wird nirgends verlinkt, verify.py prüft das auf jeder Seite**) · animierten Hintergrund (Canvas-Partikel mit Maus-Interaktion + 4 Orbs + Grid-Overlay + Grain, keine Planeten) · Glass-Cards, Reveal-Animationen, gleiche Section-Muster und Abstände. Cookie-Banner + consent-gated GA4 auf allen Seiten AUSSER Rechtsseiten (§D2). Sprachwechsler verlinkt IMMER seitenspezifisch aufs Pendant (/apps ↔ /en/apps), nie generisch auf die Startseite.
