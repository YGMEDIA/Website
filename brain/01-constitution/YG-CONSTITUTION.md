...
Jede Seite trägt identisch: Nav **auf allen Seiten außer der Startseite** (Logo `.nav-logo` links + Sprachwechsler-Dropdown `.nav-lang` rechts, keine Menüpunkte; transparent, beim Scrollen Milchglas `nav.scrolled` rgba(12,12,12,0.65) + blur 28px + feine Kante; Burger-Markup bleibt fürs Skript, ist aber auch mobil ausgeblendet; kein Calendly-CTA, keine Service-Links). **Die Startseite ist seit 2026-09-20 eine Bühne ohne Nav (Yasin), seit 2026-09-21 nur noch Logo und Footer:** eine Bildschirmseite, mittig das Logo (`.stage-logo`), unten der freie Footer mit Impressum, Datenschutz, Nutzungsbedingungen und Sprachwahl. Keine Produktkarten, keine Seitenpunkte, kein Scrollen. Der Sprachwechsel läuft über den Footer. verify.py prüft beides, inklusive Nav-Verbot auf der Startseite (P-17) · Footer (**seit 2026-09-19 eine Zeile `.footer-bottom`**: Copyright "© 2026 YG MEDIA" (ohne Personennamen, Yasin 2026-09-19) · `.footer-legal` mit Impressum/Datenschutz/Nutzungsbedingungen bzw. Legal Notice/Privacy Policy/Terms of Use · DE/EN-Pills `.lang-switch`; kein Logo, keine Tagline, keine Produkt- oder Unternehmensspalten, keine Social-Links. **X/Twitter wird nirgends verlinkt, verify.py prüft das auf jeder Seite**) · **Flow-Hintergrund (seit 2026-09-20, Yasin, nach Bildvorlage gemessen):** Grundton `--bg #020C12`, darauf `.flow` mit drei weichen blauen Farbfeldern, die auf der Stelle ineinander schwingen (links schwarz, rechts blau), dazu das feine Grain gegen Streifen. Keine Orbs, kein Raster, keine Canvas-Partikel, keine Planeten; Teal bleibt Akzentfarbe für Text und Links · Glass-Cards, Reveal-Animationen, gleiche Section-Muster und Abstände. Cookie-Banner + consent-gated GA4 auf allen Seiten AUSSER Rechtsseiten (§D2). Sprachwechsler verlinkt IMMER seitenspezifisch aufs Pendant (/apps ↔ /en/apps), nie generisch auf die Startseite.
Verstoß = eine öffentliche Seite ohne vollständige Nav/Footer/DNA oder mit vereinfachter Variante.
**Scope (präzisiert 2026-07-19, Repo gewinnt):** Gilt für alle öffentlichen Seiten. Die internen noindex-Tools (buecher-cw, more-produkt-berater) sind eigenständige Projektseiten und bewusst von DNA und GA ausgenommen; verify.py prüft sie nur auf noindex, Links, lang und Em-Dashes. Kunden-Preview-Seiten (index_*.html) sind eigenständige Kundendesigns ohne YG-Copy: noindex Pflicht, von DNA/GA UND von der Em-Dash-Regel ausgenommen (Kunden-Content); verify.py prüft sie nur auf noindex + lang und dass sie nie in der Sitemap stehen. **Weiterleitungs-Stubs (seit 2026-09-19: /usely, /en/usely)** sind keine Inhaltsseiten und tragen keine DNA, kein GA und keinen Cookie-Banner; verify.py prüft lang, meta refresh 0 aufs Ziel, Canonical genau aufs Ziel und das Sitemap-Verbot.
...
**Markenzeichen (seit 2026-09-20, Yasin bestätigt die Eintragung):** Im sichtbaren Text steht hinter der Wortmarke ein `<span class="rm">&reg;</span>` (0,62 em, hochgestellt): Footer aller Seiten, Nav-Logo-Textrückfall, Namenszeilen der Rechtsseiten. Seit dem gleichen Tag auf Yasins Wunsch auch in `<title>` aller Seiten ("Seite — YG MEDIA®") und in den Marken-Metas der Startseite (description, og:title, og:site_name, twitter:title). Ohne Zeichen bleiben `keywords` (reine Suchbegriffe) und JSON-LD `name`/`alternateName` (Entitätsname für Suchmaschinen), ebenso `alt`-Texte. Das ® setzt eine eingetragene Marke voraus; fällt die Eintragung weg, muss es zurück (sonst § 5 UWG).
...
**§A6.1 · Keine Person-Inszenierung (seit 2026-09-02):** Kein Portrait, kein "Über mich", keine Ich-Erzählung auf öffentlichen Seiten. Yasin Gündogdu erscheint nur im Impressum und im Schema (`founder`); Unternehmens-Block, Kontakt-Sektion und der Name in der Copyright-Zeile sind seit 2026-09-19 entfallen. Produkttexte beschreiben Produkte, nie den Macher.
...
sitemap.xml enthält ausschließlich indexierbare Seiten (seit 2026-09-19: 2 URLs, / und /en/). Rechtsseiten, Standalone-Seiten (felgen-brillant, pdfs/; buecher-cw, more-produkt-berater und yg-media-vision hat Yasin am 2026-09-02 gelöscht) und **Weiterleitungs-Stubs** (/usely, /en/usely seit 2026-09-19) stehen NICHT drin. Die geparkten Service-Seiten sind seit 2026-09-19 gelöscht. Jede neue indexierbare Seite → Sitemap + ggf. GSC-Neueinreichung (Yasin). verify.py gleicht beidseitig ab.
...
| Geparkte Service-Seiten (10 Dateien) tragen noch Service-Copy, Calendly-CTAs im Body und hreflang-Trios; erreichbar per Direkt-URL | §A6/§C2 | **behoben 2026-09-19** — auf Yasins Freigabe gelöscht, URLs antworten mit 404 |
...
| 2026-09-19 | v1.3 — Minimal-Auftritt (Yasin): Startseite zeigt nur noch die vier Produktkarten in einer Reihe; §A1 Nav auf Logo + Sprachwahl und Footer auf eine Zeile Copyright + Rechtliches + Sprachwahl reduziert, keine Social-Links; X/Twitter-Verbot als Gate in verify.py; §A6.1 angepasst. Details: 05-protokoll/2026-09-19-content-minimal-startseite.md. |
| 2026-09-19 | v1.4 — Aufräumen: §C2 Sitemap 2 URLs, Kategorie Weiterleitungs-Stub im §A1-Scope, Befund geparkte Seiten behoben (gelöscht). |
...
| 2026-09-21 | v2.0 — Startseite nur noch Logo und Footer (Yasin): Produktkarten und Seitenpunkte entfernt, eine Bildschirmseite ohne Scrollen; totes CSS der Startseite entfernt (38,7 auf 8,0 KB). |
| 2026-09-20 | v1.9 — Markenzeichen: ® hinter der Wortmarke im sichtbaren Text, in `<title>` und den Marken-Metas (§A5); nicht in keywords, JSON-LD und alt-Texten; Rechtsseiten-H1 mit kleiner Unterzeile "YG MEDIA®". |
