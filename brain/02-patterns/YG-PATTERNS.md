...
**Wann:** Eigene Produkte und das Partnerprojekt auf der Startseite. Seit 2026-09-19 ist das Raster der einzige Inhalt der Startseite: vier Karten USELY, YOU, Paukbox, Felgen Brillant, 4 Spalten ab 1200 px, 2 Spalten bis 768 px, darunter 1; Kartentitel als h2 unter einer unsichtbaren H1; Links bündig am Kartenboden (`.product-links` mit padding-top statt margin-top am Link). **Seit 2026-09-19 (spät):** Titel nur der Produktname, `.ref-tag` sagt in einem Stichpunkt, was es ist (in `--teal-bright`), darunter EIN Absatz mit rund 200 Zeichen nach dem Schema Funktion, Kernfeatures, Ziel/Vorteil (`text-wrap: pretty`, Zahl und Einheit mit `&nbsp;`); ab vier Spalten per Subgrid ausgerichtet (`grid-template-rows: subgrid; grid-row: span 6`, Stichpunkt `align-self: end`, Raster `row-gap: 0`), damit ein zweizeiliger Stichpunkt Titel, Text und Chips nicht versetzt. Jede Karte hat dafür genau sechs Kinder: Bild, Stichpunkt, Titel, Absatz, Chips, Links. Kein Hero, keine Hero-Kacheln, keine Footer-Produktspalte, keine Fakten-Karte mehr. Der Rest dieses Eintrags beschreibt die Kartenanatomie und gilt weiter.
...
*YG Pattern-Katalog v1.6 · 2026-09-19 (P-13 Demo-Mandant, P-14 Web-Vitals, P-15 Produktseiten-Tiefe, P-16 Logo-Animation; v1.6: P-11 kurze Karten mit Subgrid, P-16 ohne filter)*
