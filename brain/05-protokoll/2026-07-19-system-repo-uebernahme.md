...
## Nachtrag (2026-07-19, gleiche Session — Deploy-Nacharbeiten)
Beide Yasin-Handgriffe erledigt und verifiziert: (1) Enforce HTTPS aktiv — API https_enforced=true, http:// auf www UND Apex antwortet 301. (2) Sitemap (14 URLs) in GSC neu eingereicht plus 4 EN-URLs per URL-Prüfung zur Indexierung beantragt (/en/, /en/website, /en/apps, /en/usely) — Erwartungswert in GSC: Sitemap-Status "Erfolgreich", 14 entdeckte URLs nach Verarbeitung. Framework-Roadmap A + B als erledigt markiert (Änderungslog v1.1), Constitution-Befund Sitemap-Neueinreichung behoben, LOOP-STATE bereinigt. Verbleibende Menschen-Gates: GitHub-Plan, K1, Rechtstexte, erstes GSC-Wochen-Paket.
