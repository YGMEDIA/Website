...
**Letzte Aktualisierung:** 2026-09-02 (Produkt-Positionierung: Startseite DE+EN neu, Service-Seiten geparkt, Sitemap 4 URLs)
...
2. **Yasins Antworten einarbeiten** (Braucht Yasin 1–3): Löschung der Previews committen oder verwerfen; Visionskonzept verlinken ja/nein; Pitch-Deck-Erreichbarkeit.
...
0. **Löschung der Kunden-Previews (35 index_*.html), assets_02/ und more-produkt-berater.html:** Die Dateien wurden am 2026-09-02 außerhalb von Claude Code aus dem Arbeitsordner entfernt (liegen in webseiten-brain/03_Vorschau_beim_Kunden/), sind im Repo/live aber noch da. Committen = Seiten gehen vom Netz: `git add -A && git commit -m "Kunden-Previews + interne Tools aus dem Website-Repo entfernt" && git push`. Zurückholen: `git checkout -- .`
0a. **GSC nach dem Umbau:** Sitemap https://yg-media.de/sitemap.xml (4 URLs) neu einreichen; URL-Prüfung + "Indexierung beantragen" für https://yg-media.de/ und https://yg-media.de/usely. Erwartung in 2–4 Wochen: geparkte Service-URLs unter "Nicht indexiert (noindex)".
0b. **Visionskonzept verlinken?** /yg-media-vision ist noindex/nofollow und bewusst nicht von der Startseite verlinkt. Wenn gewünscht: Link "Visionskonzept 2026" im Unternehmens-Block (DE+EN), 2 Zeilen.
