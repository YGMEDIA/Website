...
|---|---|---|
| Entscheidungen & Handgriffe für Yasin | **hier unten: "Braucht Yasin"** | 4 Punkte |
| Offene Mängel mit Gesetzes-Bezug | **Constitution: Befund-Tabelle** | 2 offen (Rechtstexte, GitHub-Plan) |
...
1. **gsc-loop Lauf 1**, sobald Yasins erstes GSC-Wochen-Paket da ist (Leistung 7 Tage + Indexierung; Ablage nach P-8 in 03-research/raw/gsc/, dann auswerten). Bis dahin keine offenen Bau-Schritte.
2. Parallel offene Yasin-Entscheidungen: GitHub-Plan, Kampagne K1, Rechtstexte (siehe Braucht Yasin).
...
2. **Kampagne K1:** Start (~7 €/Tag, Phrase, /website) oder erst GSC-Daten abwarten.
...
4. **Erstes GSC-Wochen-Paket** liefern (Leistung 7 Tage + Indexierung) → startet den gsc-loop.
